...
function removeSecretConfirmController(entityKind) {
  return {
    options: {
      id: `${pluralise(entityKind)}/{serviceId}/secrets/{environment}/remove`,
      validate: {
    ...
    handler: (request, h) => {
      ...
      return h.view(
        'common/patterns/entities/tabs/secrets/views/remove-confirm',
        {
...
export { removeSecretConfirmController }
