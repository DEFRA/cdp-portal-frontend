...
const grantProdAccessFormController = {
  options: {
    id: 'teams/{teamId}/grant-prod-access/{userId}',
    auth: {
      mode: 'required',
      access: {
        scope: [
...
export { grantProdAccessFormController }
