...
import { environmentSecrets } from '~/src/server/services/service/secrets/transformers/environment-secrets.js'
...
export function environmentSecretsController(serviceOrTestSuite) {
  return {
    options: {
      id: `${serviceOrTestSuite}s/{serviceId}/secrets/{environment}`,
    ...
    handler: async (request, h) => {
      ...
      return h.view('services/service/secrets/views/environment', {
