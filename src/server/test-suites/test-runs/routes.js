import { testSuiteRunsController } from './controllers/test-suite-runs.js'
...
import { testSuiteRunController } from '#server/test-suites/test-runs/controllers/test-suite-run.js'
  ...
  plugin: {
    ...
    register: (server) => {
      server.route([
        ...
        {
          method: 'GET',
          path: '/test-suites/{serviceId}/runs/{runId}',
