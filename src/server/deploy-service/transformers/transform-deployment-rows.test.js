  ...
  test('Should provide expected deployment row transformation', async () => {
    expect(await transformDeploymentRows(deploymentSessionFixture)).toEqual([
      ...
      },
      {
        ...
        value: {
          html: '2048 (2 vCPU)\n    <div class="app-info-hint">\n      256 (.25 vCPU) allocated to sidecars. You have <strong>1792 (1.75 vCPU)</strong> available\n    </div>'
        }
      },
      {
        actions: {
        ...
        value: {
          html: '9 GB\n    <div class="app-info-hint">\n      .25 GB (256 MB) allocated to sidecars. You have <strong>8.75 GB (8960 MB)</strong> available\n    </div>'
        }
      }
    ])
  })
