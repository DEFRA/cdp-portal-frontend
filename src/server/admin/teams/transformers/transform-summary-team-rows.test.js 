  ...
  test('Should provide expected team row transformation', () => {
    expect(transformSummaryTeamRows(cdpTeamSessionFixture)).toEqual([
      ...
      },
      {
        ...
        value: {
          html: '<a class="app-link" href="https://github.com/orgs/defra-cdp-sandpit/teams/forestry-management" target="_blank" rel="noopener noreferrer">@forestry-management</a>'
        }
      }
    ])
  })
