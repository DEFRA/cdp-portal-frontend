...
// Response from selfServiceOpsApi/create-service/status/in-progress/cdp-portal-frontend
const inProgressServiceStatusFixture = {
  message: 'success',
  inProgress: {
    kind: 'repository',
    org: githubOrg,
...
export { inProgressServiceStatusFixture }
