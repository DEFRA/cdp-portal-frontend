  ...
  repositories: [
    {
      ...
      primaryLanguage: 'C#',
      url: 'https://github.com/defra-cdp-sandpit/cdp-portal-backend',
      isArchived: false,
      isTemplate: false,
      isPrivate: true,
  ...
  templates: [
    {
      ...
      primaryLanguage: 'JavaScript',
      url: 'https://github.com/defra-cdp-sandpit/cdp-node-backend-template',
      isArchived: false,
      isTemplate: true,
      isPrivate: true,
    ...
    },
    {
      ...
      primaryLanguage: 'JavaScript',
      url: 'https://github.com/defra-cdp-sandpit/cdp-node-frontend-template',
      isArchived: false,
      isTemplate: true,
      isPrivate: true,
