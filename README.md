...
awslocal s3 sync . "s3://cdp-documentation/" \
          --exclude ".editorconfig" --exclude ".github/*" --exclude ".git/*" --exclude ".gitignore" --exclude "cspell.yml" --exclude ".markdownlint.yml" --exclude "README.md" --exclude "CONTRIBUTING.md" \
